    ...
    <View style={styles.container}>
      ...
      <BlurView intensity={70} tint="light" style={styles.glassCard}>
        <View style={styles.textContainer}>
          <Text style={styles.title}>Your Safe Space for Mental Wellness</Text>
          <Text style={styles.description}>
            MindMate helps you track your mood, reflect through journaling, and
            build healthier habits — all in one calm, supportive space.
          </Text>
